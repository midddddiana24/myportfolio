  ...
  return (
    <div className={cn('flex items-center gap-2.5', className)}>
      <svg width={size} height={size} viewBox="0 0 32 32" fill="none" aria-label="RM logo">
        <rect width="32" height="32" fill="#ffffff" fillOpacity="0.08" />
        <rect x="0.5" y="0.5" width="31" height="31" stroke="#ffffff" strokeOpacity="0.3" />
        <text x="4" y="22" fontFamily="'DM Mono', monospace" fontWeight="500" fontSize="14"
          fill="#ffffff" letterSpacing="-0.5">RM</text>
